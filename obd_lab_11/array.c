...
const char UNIVERSITY_TYPE[] = "university";
const char FACULTY_TYPE[] = "faculty";
...
void printArray(Array* array) {
    ...
    for(int i = 0; i < array->actualSize; ++i) {
        if(strcmp(array->typeName, INTEGERS_TYPE) == 0) {
            ...
            printf("    ");
            printKeys(keys);
        } else if(strcmp(array->typeName, UNIVERSITY_TYPE) == 0) {
            University* university = array->arr[i];
            printf("    ");
            printUniversity(university);
        } else if(strcmp(array->typeName, FACULTY_TYPE) == 0) {
            Faculty* faculty = array->arr[i];
            printf("    ");
